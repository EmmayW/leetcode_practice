...
public class M3043LongestCommonPrefixLengthSolutionTest {
    ...
    void longestCommonPrefix(@ConvertWith(StringIntegerArrayConverter.class) int[] arr1, @ConvertWith(StringIntegerArrayConverter.class) int[] arr2, int expectedResult) {
